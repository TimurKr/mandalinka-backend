...
function initMap() {
  const CONFIGURATION = {
    ctaTitle: "Uložiť",
    mapOptions: {
      center: { lat: 48.148454532384875, lng: 17.10543733560417 },
  ...
  const componentForm = ["address", "district", "city", "postal", "country"];

  const getFormInputElement = (component) =>
    document.getElementById("id_" + component);
  ...
  function fillInAddress(place) {
    ...
    getFormInputElement("district").value = getAddressComp(
      "sublocality_level_1"
    );
