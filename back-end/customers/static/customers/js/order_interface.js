...
var OrderInterface = (function (_React$Component) {
  ...
  function OrderInterface(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (OrderInterface.__proto__ || Object.getPrototypeOf(OrderInterface)).call(
        this,
        props
      )
    );
    ...
    _this.minus_sign = function () {
      if (_this.props.amount > 0) {
        ...
        return React.createElement("i", {
          className: "bi bi-dash-lg disabled",
        });
      }
    };
      ...
      if (_this.props.amount < 0) {
        ...
        return React.createElement(
          "a",
          {
            className: "p-0 m-0",
            role: "button",
            onClick: _this.change_portions.bind(_this, 2),
          },
        ...
        fetch("/edit_order", put_info)
          .then(function (answer) {
            if (answer.status === 200) {
              _this2.props.onAmountChange(
                new_amount,
                _this2.props.recipe_order_instance_id
              );
    ...
    },
    {
      ...
      value: function render() {
        return React.createElement(
          ...
          {
            className:
              "hstack order-interface allign-middle position-absolute top-0 end-0 translate-middle-y  " +
              (this.props.amount > 0 ? "active" : "inactive"),
          },
          this.minus_sign(),
          this.state.loading
            ? React.createElement(Spinner, null)
            : React.createElement("h3", null, " ", this.props.amount, " "),
          this.plus_sign()
        );
      },
    },
