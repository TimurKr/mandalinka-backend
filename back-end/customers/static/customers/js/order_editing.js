...
var root = ReactDOM.createRoot(document.getElementById("current-order"));
...
var OrderEditing = (function (_React$Component) {
  ...
  function OrderEditing(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (OrderEditing.__proto__ || Object.getPrototypeOf(OrderEditing)).call(
        this,
        props
      )
    );
    ...
    _this.set_total_price = function (recipes) {
      ...
      try {
        for (
          var _iterator = Object.entries(recipes)[Symbol.iterator](), _step;
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (this.state.recipes != undefined) {
          ...
          try {
            for (
              var _iterator2 = Object.entries(this.state.recipes)[
                  Symbol.iterator
                ](),
                _step2;
              ...
              try {
                for (
                  var _iterator3 = Object.entries(this.state.attributes)[
                      Symbol.iterator
                    ](),
                    _step3;
              ...
              recipes[rec_data.type].push(
                React.createElement(RecipeWidget, {
                  key: rec_key,
        ...
        try {
          for (
            var _iterator4 = Object.keys(recipes)
                .sort()
                .reverse()
                [Symbol.iterator](),
              _step4;
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(DeliveryType, {
                pickup: this.state.pickup,
                toggle: this.toggle_pickup,
              }),
