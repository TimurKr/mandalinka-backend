...
var Attributes = (function (_React$Component) {
  ...
  function Attributes() {
    ...
    return _possibleConstructorReturn(
      this,
      (Attributes.__proto__ || Object.getPrototypeOf(Attributes)).apply(
        this,
        arguments
      )
    );
  ...
  _createClass(Attributes, [
    {
      ...
      value: function render() {
        ...
        try {
          for (
            var _iterator = Object.entries(this.props.attrs)[Symbol.iterator](),
              _step;
            ...
            if (value.favorite && value.selected) {
              attrs_fav_sel.push(
                React.createElement(JsxAttribute, {
                  title: key,
