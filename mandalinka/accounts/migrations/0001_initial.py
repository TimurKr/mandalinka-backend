    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alergies', models.ManyToManyField(blank=True, default=None, help_text='Máte nejaké alergie? Povedzte nám o nich teraz a my vám nikdy automaticky neobjednáme recept obsahujúci daný alergén.', related_name='users', to='ingredients.alergen', verbose_name='Alergie')),
            ],
            options={
                'verbose_name': 'user',
