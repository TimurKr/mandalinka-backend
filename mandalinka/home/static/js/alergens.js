...
var Alergens = function (_React$Component) {
    ...
    function Alergens() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Alergens.__proto__ || Object.getPrototypeOf(Alergens)).call.apply(_ref, [this].concat(args))), _this), _this.get_print_codes = function () {
            var print_codes = [];
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'svg',
                        { className: 'bi bi-info-circle pb-1', xmlns: 'http://www.w3.org/2000/svg', width: '16', height: '16',
