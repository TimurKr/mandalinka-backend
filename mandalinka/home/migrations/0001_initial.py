    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alergies', models.ManyToManyField(blank=True, related_name='users', to='recepty.alergen')),
                ('food_preferences', models.ManyToManyField(blank=True, related_name='users', to='recepty.foodattribute')),
